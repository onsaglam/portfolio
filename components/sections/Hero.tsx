...
const roles = [
  ...
  'Co-Founder @ AES · 300+ Beratene Studierende',
  '3× Gründer · Digitaler Allrounder',
]
      ...
      <div className="relative max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1">
            ...
            >
              Marketing & Funnels · Universität Bremen · Bremen, DE
            </motion.p>
          ...
          <motion.div
            ...
            className="mt-12 lg:mt-0 flex-shrink-0 flex justify-center lg:justify-end"
          >
            <div className="relative w-56 h-56 lg:w-72 lg:h-72">
              <div className="absolute inset-0 rounded-full border border-[#FF440030]" />
              <div className="absolute inset-[6px] rounded-full border border-[#FF440015]" />
              <Image
                src="/onat-photo.jpg"
                alt="Onat Can Saglam"
                fill
